...
public class PopulationManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Vector3 startingPos = new Vector3(transform.position.x + Random.Range(-2.0f, 2.0f), transform.position.y, transform.position.z + Random.Range(-2.0f, 2.0f));
    ...
    GameObject Breed(GameObject parentA, GameObject parentB)
    {
        ...
        {
            b.Init();
            b.dna.Combine(parentA.GetComponent<Brain>().dna, parentB.GetComponent<Brain>().dna);
        }
        return offspring;
    }
